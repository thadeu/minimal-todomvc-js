  ...
  refreshTodoList: function() {
    ...
    let todoCard = todo => `<div class="flex justify-center mb-4 w-full">
      <div class="max-w-md w-full lg:flex">
        <div class="border border-grey-light bg-white rounded-b p-4 flex flex-col justify-between leading-normal w-full">
          <div class="">
            <div class="text-black font-bold text-xl">${todo.name}</div>
          </div>
        </div>
      </div>
    </div>`
